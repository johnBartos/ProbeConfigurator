...
#define RIGHT_PROBE_BED_POSITION 2
#define BACK_PROBE_BED_POSITION 3
...
#define XY_TRAVEL_SPEED 8

#define Z_RAISE_BEFORE_PROBING 1
#define Z_RAISE_BETWEEN_PROBING 2
...
#define SERVO_ENDSTOP_ANGLES 23
